 ...
 * @author Erdenetulga
 */
public class GetSuggestedClassroomCoursesUseCaseDelegator implements UseCaseDelegator<GetCoursesInput, List<CourseDto>>
{
  private Map<String, UseCase<GetCoursesInput, List<CourseDto>>> registry;

  public GetSuggestedClassroomCoursesUseCaseDelegator()
  {

...
import mn.erin.lms.base.domain.usecase.course.classroom.dto.SetReasonInput;

/**
 * @author Munkh
 */
public class SetClassroomCourseReason extends CourseUseCase<SetReasonInput, Void>
{
  public SetClassroomCourseReason(LmsRepositoryRegistry lmsRepositoryRegistry,
  ...
  @Override
  public Void execute(SetReasonInput input) throws UseCaseException
  {
    try
    {

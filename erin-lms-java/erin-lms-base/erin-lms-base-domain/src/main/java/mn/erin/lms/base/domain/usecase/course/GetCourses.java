...
public class GetCourses extends CourseUseCase<GetCoursesInput, List<CourseDto>>
{
  private final UseCaseDelegator<GetCoursesInput, List<CourseDto>> useCaseDelegator;

  public GetCourses(LmsRepositoryRegistry lmsRepositoryRegistry, LmsServiceRegistry lmsServiceRegistry,

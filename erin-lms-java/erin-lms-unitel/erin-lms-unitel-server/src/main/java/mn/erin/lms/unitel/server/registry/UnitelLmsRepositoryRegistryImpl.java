 ...
 */
public class UnitelLmsRepositoryRegistryImpl implements UnitelLmsRepositoryRegistry, BeanFactoryAware
{
  ...
  {
    return beanFactory.getBean(ExamRuntimeDataRepository.class);
  }

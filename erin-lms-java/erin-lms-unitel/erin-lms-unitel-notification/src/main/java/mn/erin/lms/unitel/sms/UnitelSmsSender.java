 ...
 */
public class UnitelSmsSender implements SmsSender
{
  private static final MediaType JSON = MediaType.parse("application/json; charset=utf-8");
  private static final Logger LOGGER = LoggerFactory.getLogger(UnitelSmsSender.class);
  ...
  public boolean sendSms(String phoneNumber, String message)
  {
    ...
    {
      LOGGER.error("Unable to send, connect timed out.");
      return false;
    }
  }
}

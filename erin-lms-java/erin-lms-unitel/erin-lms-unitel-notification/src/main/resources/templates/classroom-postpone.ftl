          ...
          <table bgcolor='#FFFFFF' width='80%' border='0'>
            ...
            <tr style='color:#a2a2a2;height:45px;text-align:center;'>
              <td style="font-size:16px; text-align:center;">
                <span><b style='color:#575252;'>"${courseTitle}"</b> <b style='color:#575252;'>${date}</b> өдөр <b style='color:#575252;'>${startTime} - ${endTime}</b> цагт зохион байгуулагдах танхимын  сургалт хойшлогдсон тул сургалтын хугацааг эргэн мэдэгдэх болно.</span>
              </td>
            </tr>
            <tr style='color:#a2a2a2;font-size:16px;height:45px;text-align:center;'>
              <td>
                <span>Шалтгаан: ${reason}</span>
              </td>
            </tr>
            <tr style='color:#a2a2a2;font-size:16px;height:45px;text-align:center;'>
              <td>
                <span>Хойшлуулсан  админ: ${authorId}</span>
              </td>
            </tr>
            <tr style='color:#a2a2a2;font-size:16px;height:45px;text-align:center;'>
              <td>

        ...
        <center>
          ...
          <tr style='color:#a2a2a2;height:45px;text-align:center;'>
            <td style="font-size:16px; text-align:center;">
              <span>Таны хамрагдах <b style='color:#575252;'>${courseTitle}"</b>
                сургалт нь <b style='color:#575252;'>${date}</b> өдөр <b style='color:#575252;'>${startTime} - ${endTime}</b>
                цагт <b style='color:#575252;'>"${location}"</b>-д орохоор болж өөрчлөгдлөө.
                Та сургалтандаа цагтаа ирж хамрагдана уу.</span>
            </td>
          </tr>

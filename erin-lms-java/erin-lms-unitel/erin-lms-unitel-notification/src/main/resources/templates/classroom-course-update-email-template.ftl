      ...
      <td>
        <center>
          ...
          <tr style='text-align:center;color:#a2a2a2;font-size:16px;height:45px;'>
              <#if previousName??>
                <td>
                  <span>Таны хамрагдах <b style='color:#575252;'>${previousName}</b>  сургалтын нэр <b style='color:#575252;'>${courseName}</b> нэртэй болж өөрчлөгдлөө. Хамрах хүрээ <b style='color:#575252;'>${courseType}</b> боллоо.</span>
                </td>
              <#else>
                <td>
                  <span>Таны хамрагдах <b style='color:#575252;'>${courseName}</b> нэртэй сургалт <b style='color:#575252;'>${courseType}</b> хамрах хүрээтэй болж өөрчлөгдлөө.</span>
                </td>
              </#if>
          </tr>
          ...
          <tr style='color:#a2a2a2;font-size:16px;height:45px;text-align:center;'>
            <td>
              <a
                ...
                href="${domainName}/#/classroom-course/launch/${courseId}">ТАНИЛЦАХ</a>
            </td>
          </tr>

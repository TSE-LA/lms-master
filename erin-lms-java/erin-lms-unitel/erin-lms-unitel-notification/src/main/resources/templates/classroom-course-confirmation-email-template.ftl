        ...
        <center>
          ...
          <tr style='color:#a2a2a2;height:45px;text-align:center;'>
            <td style="font-size:16px; text-align:center;">
              <span>Танд <b style='color:#575252;'>“${courseName}”</b> <b style='color:#575252;'>${date}</b> өдрийн <b style='color:#575252;'>${startTime} - ${endTime}</b> цагт танхимаар зохион байгуулагдах сургалтын урилга ирлээ. Сургалт <b style='color:#575252;'>${address}</b>-д болох тул та цагтаа хамрагдана уу.</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:16px;height:45px;text-align:center;'>
            <td>
              <span>Урилга илгээсэн админ: ${authorId}</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:16px;height:45px;text-align:center;'>
            <td>

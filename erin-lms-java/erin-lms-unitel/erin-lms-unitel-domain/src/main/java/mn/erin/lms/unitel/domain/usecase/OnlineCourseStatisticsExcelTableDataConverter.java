...
public class OnlineCourseStatisticsExcelTableDataConverter implements ExcelTableDataConverter<List<CourseReportDto>>
{
  ...
  public Object[][] convert(List<CourseReportDto> reportResults)
  {
    ...
    for (int index = 0; index < reportDataSize; index++)
    {
      ...
      String lastViewDate = (String) courseReportData.get(CourseConstants.PROPERTY_LAST_LAUNCH);
      ...
      Object[] row = { 0, name, group, status, spentTimeRatio, viewDate, lastViewDate, viewCount, spentTime, testScore, spentTimeOnTest, certificate, survey };

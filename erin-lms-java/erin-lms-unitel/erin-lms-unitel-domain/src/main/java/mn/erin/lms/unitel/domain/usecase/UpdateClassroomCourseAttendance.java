 ...
 * @author Munkh
 */
public class UpdateClassroomCourseAttendance extends CourseUseCase<CourseAttendanceInput, Void>
{
...
public UpdateClassroomCourseAttendance(LmsRepositoryRegistry lmsRepositoryRegistry,
  ...
  public Void execute(CourseAttendanceInput input)
  {
    ...
    ClassroomCourseAttendance classroomCourseAttendance = new ClassroomCourseAttendance(CourseId.valueOf(input.getCourseId()), attendances);

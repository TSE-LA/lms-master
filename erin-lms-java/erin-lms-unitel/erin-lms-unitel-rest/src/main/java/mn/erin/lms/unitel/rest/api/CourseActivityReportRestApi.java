...
import mn.erin.lms.unitel.domain.usecase.DownloadClassroomCourseActivityReports;
import mn.erin.lms.unitel.domain.usecase.DownloadCourseActivityReports;
import mn.erin.lms.unitel.domain.usecase.GenerateClassroomActivityReports;
import mn.erin.lms.unitel.domain.usecase.GenerateCourseActivityReports;
...
public class CourseActivityReportRestApi extends BaseLmsRestApi
{
  ...
  )
  {
    ...
    DownloadClassroomCourseActivityReports downloadClassroomCourseActivityReports = new DownloadClassroomCourseActivityReports(lmsRepositoryRegistry,
        lmsServiceRegistry);
    List<ClassroomActivityReportDto> result;
    String currentFormattedDate = DateTimeUtils.getCurrentLocalDateTime(DateTimeUtils.LONG_ISO_DATE_FORMAT);

    try
    {
      result = generateClassroomActivityReports.execute(filter);

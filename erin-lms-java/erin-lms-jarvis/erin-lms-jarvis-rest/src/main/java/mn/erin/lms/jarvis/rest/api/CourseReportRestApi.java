...
import mn.erin.lms.jarvis.domain.report.usecase.DownloadClassroomCourseReports;
import mn.erin.lms.jarvis.domain.report.usecase.DownloadCourseReports;
import mn.erin.lms.jarvis.domain.report.usecase.GenerateClassroomCourseReports;
import mn.erin.lms.jarvis.domain.report.usecase.GenerateCourseReports;
...
public class CourseReportRestApi extends BaseLmsRestApi
{
  ...
  CourseReportRestApi(LmsRepositoryRegistry lmsRepositoryRegistry, JarvisLmsServiceRegistry lmsServiceRegistry)
  {
  ...
  {
    GenerateCourseReports generateCourseReports = new GenerateCourseReports(lmsRepositoryRegistry, (JarvisLmsServiceRegistry) lmsServiceRegistry);
  ...
  @ApiOperation("Download Online course Table Excel Report")
  @GetMapping("/online-course-report-excel")
  ...
  )
  {
    ...
    List<CourseReportDto> reportResults;
    ReportFilter filter = new ReportFilter(departmentId, startDate, endDate);
    filter.setCategoryId(categoryId);
    filter.setCourseType(courseType);

...
import mn.erin.lms.base.domain.usecase.course.classroom.GetClassroomCourseTotalScore;
import mn.erin.lms.base.rest.api.BaseLmsRestApi;
import mn.erin.lms.jarvis.domain.report.usecase.GetOnlineCourseTotalScore;
...
public class LearnerTotalScoreRestApi extends BaseLmsRestApi
{
  ...
  {
    GetOnlineCourseTotalScore getOnlineCourseTotalScore = new GetOnlineCourseTotalScore(lmsRepositoryRegistry, (JarvisLmsServiceRegistry) lmsServiceRegistry);
    try
    {

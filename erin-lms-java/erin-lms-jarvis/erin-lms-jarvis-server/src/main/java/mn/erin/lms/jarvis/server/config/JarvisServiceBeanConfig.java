...
import mn.erin.lms.base.domain.service.impl.JarvisOrganizationIdProvider;
import mn.erin.lms.base.domain.service.impl.MainCourseTypeResolver;
import mn.erin.lms.base.domain.service.impl.PromotionQuestionnaireService;
...
import mn.erin.lms.jarvis.JarvisNotificationBeanConfig;
import mn.erin.lms.jarvis.JarvisNotificationService;
...
import mn.erin.lms.jarvis.domain.report.service.impl.AssessmentReportServiceImpl;
import mn.erin.lms.jarvis.domain.report.service.impl.CourseActivityReportServiceImpl;
import mn.erin.lms.jarvis.domain.report.service.impl.CourseAnalyticsServiceImpl;
import mn.erin.lms.jarvis.domain.report.service.impl.CourseReportServiceImpl;
import mn.erin.lms.jarvis.domain.report.service.impl.EmployeeAnalyticsServiceImpl;
import mn.erin.lms.jarvis.domain.repository.JarvisLmsRepositoryRegistry;
import mn.erin.lms.jarvis.server.registry.JarvisLmsServiceRegistryImpl;

/**
 * @author Bat-Erdene Tsogoo.
 */
@Configuration
@Import({ JarvisNotificationBeanConfig.class })
public class JarvisServiceBeanConfig
{
  @Autowired
  ...
  {
    return new JarvisLmsServiceRegistryImpl();
  }
  ...
  {
    return new AssessmentReportServiceImpl((JarvisLmsRepositoryRegistry) lmsRepositoryRegistry);
  }
  ...
  {
    return new JarvisNotificationService(lmsUserService, emailService, smsSender, smsMessageFactory, accessIdentityManagement);
  }

  @Bean
  public OrganizationIdProvider organizationIdProvider()
  {
    return new JarvisOrganizationIdProvider();
  }
  ...
  @Bean
  public ThumbnailService thumbnailService(SCORMRepositoryRegistry scormRepositoryRegistry, LmsFileSystemService lmsFileSystemService, CourseRepository courseRepository)
  {

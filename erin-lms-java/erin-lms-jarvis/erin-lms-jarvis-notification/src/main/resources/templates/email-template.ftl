        ...
        <center>
          ...
          <tr style='color:#a2a2a2;height:45px;'>
            <td style="font-size:14px">
              <span>Танд <b style='color:#575252;'>${courseName}</b> цахим сургалт нийтлэгдлээ.</span>
          ...
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>
                <#if memo??>
                  <span><b style='color:#575252;'>Тэмдэглэл:</b>${memo}</span>
                </#if>
            </td>
          </tr>
          ...
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>
              <span><b style='color:#575252;'>Нийтэлсэн багш:</b> ${authorId}</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>

        ...
        <center>
          ...
          <tr style='color:#a2a2a2;height:45px;'>
            <td style="font-size:14px">
              <span>Танд <b style='color:#575252;'>${courseTitle}</b> танхимын сургалт <b style='color:#575252;'>${date}</b> өдөр <b style='color:#575252;'>${startTime} - ${endTime}</b> цагт <b style='color:#575252;'>${location}-нд</b> орохоор болж өөрчлөгдсөн тухай мэдээлэл ирлээ. Та сургалтандаа цагтаа ирж хамрагдана уу.</span>
          ...
          <tr style='text-align:center;color:#a2a2a2;font-size:14px;height:45px;'>
            <td>
              <a href="${domainName}/#/classroom-course/launch/${courseId}">ТАНИЛЦАХ</a></span>
            </td>
          </tr>
          </tbody>
  </table>

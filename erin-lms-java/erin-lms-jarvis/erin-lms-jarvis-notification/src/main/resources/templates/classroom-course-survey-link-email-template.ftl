        ...
        <center>
          ...
          <tr style='color:#a2a2a2;height:45px;'>
            <td style="font-size:14px">
              <span>
              Танд <b style='color:#575252;'>${date}${courseTitle}</b> танхимын сургалт хаагдсан тухай мэдээлэл ирлээ. Сургалттай холбоотой үнэлгээний хуудсыг бөглөнө үү.
               </span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>
              <span><b style='color:#575252;'>Сургалт зохион байгуулсан багш:</b> ${authorId}</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>
          ...
          <tr style='text-align:center;color:#a2a2a2;font-size:14px;height:45px;'>
            <td>
              <a href="${domainName}/#/classroom-course/assessment/launch/${courseId}">ҮНЭЛГЭЭ БӨГЛӨХ</a></a></span>
            </td>
          </tr>
          </tbody>
  </table>

    ...
    <tr>
      <td>
        <center>
          ...
          <tr style='text-align:center;color:#a2a2a2;font-size:14px;height:45px;'>
              <#if previousName??>
                <td style="font-size:14px">
                  <span>
                  Танд <b style='color:#575252;'>${previousName}</b> сургалтын нэр <b style='color:#575252;'>${courseName}</b> болж, хамрах хүрээ <b style='color:#575252;'>${courseType}</b> болж өөрчлөгдсөн тухай мэдээлэл ирлээ.</span>
                </td>
              <#else>
                <td style="font-size:14px">
                  <span>Танд <b style='color:#575252;'>${courseName}</b> сургалт <b style='color:#575252;'>${courseType}</b> хамрах хүрээтэй болж өөрчлөгдсөн тухай мэдээлэл ирлээ.</span>
                </td>
              </#if>
          </tr>
          ...
          <tr style='text-align:center;color:#a2a2a2;font-size:14px;height:45px;'>
            <td>
              <a href="${domainName}/#/online-course/launch/${courseId}/true">ТАНИЛЦАХ</a></a></span>
            </td>
          </tr>
          </tbody>
  </table>

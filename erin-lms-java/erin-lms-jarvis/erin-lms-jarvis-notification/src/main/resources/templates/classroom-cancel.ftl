        ...
        <center>
          ...
          <tr style='color:#a2a2a2;height:45px;'>
            <td style="font-size:14px">
              <span>Танд <b style='color:#575252;'>${date}</b> өдөр <b style='color:#575252;'>${startTime} - ${endTime}</b> цагт зохион байгуулагдах <b style='color:#575252;'>"${courseTitle}"</b> танхимын сургалт цуцалсан тухай мэдээлэл ирлээ.</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>
              <span><b style='color:#575252;'>Шалтгаан:</b> ${reason}</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>
              <span><b style='color:#575252;'>Цуцалсан багш:</b> ${authorId}</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>

        ...
        <center>
          ...
          <tr style='color:#a2a2a2;height:45px;'>
            <td style="font-size:14px">
              <span>
              Танд <b style='color:#575252;'>${date}</b> өдөр <b style='color:#575252;'>${startTime}-${endTime}</b> цагт зохион байгуулагдах <b style='color:#575252;'>${courseName}</b> танхимын сургалт хойшлогдсон тухай мэдээлэл ирлээ, сургалтын хугацааг эргэн мэдэгдэх болно.
               </span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>
              <span><b style='color:#575252;'>Шалтгаан:</b> ${note}</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>
              <span><b style='color:#575252;'>Хойшлуулсан багш:</b> ${authorId}</span>
            </td>
          </tr>
          <tr style='color:#a2a2a2;font-size:14px;height:30px;'>
            <td>

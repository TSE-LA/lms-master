...
@Component({
  selector: 'jrs-online-course-group-enrollment-page',
  template: `
    <jrs-button
...
export class OnlineCourseGroupEnrollmentPageComponent implements OnInit {
    ...
    this.sb.getAllUsers().subscribe(res => {
      ...
      this.route.paramMap.subscribe(params => {
        ...
        this.sb.getOnlineCourseById(this.courseId).subscribe(res => {
          ...
          this.selectedUsers = res.assignedLearners;
          this.setSelectedUsers();
          this.sb.getCourseEnrollmentGroup(this.onlineCourse.id).subscribe(res => {
            this.groups = res;
            this.loading = false;
  ...
  saveEnrollment(): void {
    ...
    this.saving = true;
    this.sb.saveEnrollment(this.courseId, this.selectedUsers, groups).subscribe(() => {
  ...
  removeUser(user: LearnerInfo): void {
    ...
    if (!user.selected) {
      ...
      const enrolledUsers = this.getEnrolledUsers();
      this.selectedUsers.push(...enrolledUsers)
  ...
  goBackToUpdatePage(): void {
    this.sb.navigateByUrl('/online-course/update/' + this.onlineCourse.id);
  }

...
import { TimedCourseContainerComponent } from "../../../../libs/core/src/lib/timed-course/containers/timed-course-container/timed-course-container.component";
...
import { TimedCourseComponent } from "../../../../libs/core/src/lib/timed-course/component/timed-course/timed-course.component";
import { TimedCourseUpdatePageComponent } from "../../../../libs/core/src/lib/timed-course/containers/timed-course-update-page/timed-course-update-page.component";
import { TimedCourseLaunchPageComponent } from "../../../../libs/core/src/lib/timed-course/containers/timed-course-launch-page/timed-course-launch-page.component";
import { TimedCourseCreatePageComponent } from "../../../../libs/core/src/lib/timed-course/containers/timed-course-create-page/timed-course-create-page.component";
...
import { TimedCourseStatisticsComponent } from "../../../../libs/core/src/lib/timed-course/containers/timed-course-statistics/timed-course-statistics.component";
...
import { TimedCourseReadingPageComponent } from "../../../../libs/core/src/lib/timed-course/containers/timed-course-reading-page/timed-course-reading-page.component";
...
import { TimedCourseGroupEnrollmentPageComponent } from "../../../../libs/core/src/lib/timed-course/containers/timed-course-group-enrollment-page/timed-course-group-enrollment-page.component";
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "timed-course",
        component: TimedCourseComponent,
        data: {
          title: "Урамшуулал",
        },
        children: [
          ...
          {
            path: "container",
            component: TimedCourseContainerComponent,
            data: {
              title: "Урамшуулал",
            },
          },
          {
            path: "create",
            component: TimedCourseCreatePageComponent,
            data: {
              id: "app.promotion.create",
              title: "Урамшуулал үүсгэх",
            },
          },
          {
            path: "update/:id",
            component: TimedCourseUpdatePageComponent,
            data: {
              id: "app.promotion.update",
              title: "Урамшуулал засварлах",
            },
          },
          {
            path: "update/:id/group-enrollment",
            component: TimedCourseGroupEnrollmentPageComponent,
            data: {
              id: "app.timed-course.group-enrollment",
              title: "Урамшуулалд суралцагч группээр оноох",
            },
          },
          {
            path: "launch/:id/:isContinue",
            component: TimedCourseLaunchPageComponent,
            canDeactivate: [CanDeactivateGuard],
            data: {
              id: "app.promotion.launch",
              title: "Урамшуулалтай танилцах хуудас",
            },
          },
          {
            path: "read/:id",
            component: TimedCourseReadingPageComponent,
            data: {
              title: "Урамшуулал унших хуудас",
            },
          },
          {
            path: "statistics/:id",
            component: TimedCourseStatisticsComponent,
            data: {
              id: "app.promotion.statistics",
              title: "Урамшууллын статистик",
            },
          },
          {
